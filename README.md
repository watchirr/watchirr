...
Both paths use the published image `ghcr.io/watchirr/watchirr:v1.0.3` and store SQLite at `./data/watchirr.db` on the host. Optional Postgres and reverse-proxy notes live in **[docs/self-host.md](./docs/self-host.md)**.
